# Azure Cognitive Services Anomaly Detector client library for Python
...
```bash
python -m pip install azure-mdkservices-anomalydetector
```
...
- An existing Azure Cognitive Services Anomaly Detector instance.
...
>>> client = AnomalyDetectorClient(endpoint='<endpoint>', credential=DefaultAzureCredential())
```
